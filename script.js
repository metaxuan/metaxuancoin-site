...
const visionTranslations = {
  "en": {
    ...
    "vision": {
      "short": "Listening to the voices of the world, responding with compassion and wisdom.",
      "medium": "MetaXuan Coin is a light that connects hearts, allowing kindness to flow across borders. We believe that every act of kindness can change a corner of the world.",
      "long": "MetaXuan Coin is a global decentralized asset inspired by the spirit of 'Om Mani Padme Hum'. It aims to enhance fair resource allocation and charitable transparency through blockchain technology."
    }
  },
  "zh-TW": {
    "visionBtn": "🌍 觀看願景",
