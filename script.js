...
const visionTranslations = {
  ...
  function applyVisionTranslation(lang) {
  const visionData = visionTranslations[lang] || visionTranslations["en"];
  document.getElementById("vision-short").innerText = visionData.short;
  document.getElementById("vision-medium").innerText = visionData.medium;
  document.getElementById("vision-long").innerText = visionData.long;
}
